...
client-update mechanism is the `CACHE_VERSION` string: **bump it whenever
any precached asset changes**, or installed clients keep stale assets.
Icons are generated by `scripts/generate-icons` (Pillow, dev-only dep).
